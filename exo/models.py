...
model_base_shards = {
  ...
  "llava-1.5-7b-hf": {
    ...
    "TinygradDynamicShardInferenceEngine": Shard(model_id="llava-hf/llava-1.5-7b-hf", start_layer=0, end_layer=0, n_layers=32),
  },
  "llava-1.5-13b-hf": {
    "MLXDynamicShardInferenceEngine": Shard(model_id="llava-hf/llava-1.5-13b-hf", start_layer=0, end_layer=0, n_layers=40),
  },
  ### qwen
  "qwen-2.5-coder-1.5b": {
